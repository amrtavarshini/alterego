<?php
/**
 * Alter Ego functions and definitions
 *
...
if ( ! function_exists( 'alterego_setup' ) ) :
	/**
	...
	function alterego_setup() {
		 ...
		 * If you're building a theme based on Alter Ego, use a find and replace
		...
		add_theme_support( 'custom-background', apply_filters( 'alterego_custom_background_args', array(
